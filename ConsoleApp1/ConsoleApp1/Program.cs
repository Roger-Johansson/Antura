...
namespace ConsoleApp1
{
    ...
    {
        /*
         This program counts the occurences of a given text file name in the text file contents.
        ...
        */
        static int Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                ...
                System.Console.WriteLine("NOTE! Place text file in the same folder as ConsoleApp1.exe.");
                return 1;
            }
